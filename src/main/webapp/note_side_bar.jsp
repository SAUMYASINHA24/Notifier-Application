    ...
    <div class="wrapper">
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components">
                ...
                <li>
                    <a href="#" data-toggle="modal" data-target="#exampleModalCenter">Edit User</a>
                </li>
                <li>
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light" style = "background-color: #212529 !important ">
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="nav navbar-nav ml-auto" >
                            <li class="nav-item active" >
                                <a class="nav-link" data-toggle="modal" data-target="#exampleModal" style = "color: white;">New Note</a>
                            </li>
                            <li class="nav-item active" >
            		...
            		<%
						...
						//NoteBookDao nbd = new NoteBookDao();
						//List<ArrayList<String>> notebooks = nbd.getNoteBook(email);
						//for(int i = 0; i < notebooks.size(); i+=1)
						//{,notebooks.get(i).get(0)
		      ...
		      <div class="modal-body">
		        	<%
						...
						{%>
						    ...
						    <h3 style = "color:blue;">Hooray!!! No tasks pending.</h3> 
							</div>
						<% }
						else
						{
